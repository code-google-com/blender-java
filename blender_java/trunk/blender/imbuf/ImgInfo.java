/**
 * $Id: imginfo.c 12931 2007-12-17 18:20:48Z theeth $ 
 *
...
public class ImgInfo extends Link<ImgInfo> {

    public byte[] key;
    public byte[] value;
    public int len;

public static void IMB_imginfo_free(ImBuf img)
{
	ImgInfo info;

	if (img==null)
		return;
	if (img.img_info==null) {
		return;
	}
	info = img.img_info;
	while (info!=null) {
