...
//int WM_operator_confirm(bContext *C, wmOperator *op, wmEvent *event)
{
	...
	layout= UIRegions.uiPupMenuLayout(pup);
	UILayout.uiItemO(layout, C, null, 0, ((wmOperatorType)op.type).idname);
	UIRegions.uiPupMenuEnd(C, pup);
...
//static int wm_recentfile_invoke(bContext *C, wmOperator *op, wmEvent *event)
{
	...
	layout= UIRegions.uiPupMenuLayout(pup);
	UILayout.uiItemsEnumO(layout, C, ((wmOperatorType)op.type).idname, "file");
	UIRegions.uiPupMenuEnd(C, pup);
...
{
	WmOperatorsUtil.WM_operatortype_append(WM_OT_window_duplicate);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_read_homefile);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_read_factory_settings);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_save_homefile);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_window_fullscreen_toggle);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_quit_blender);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_open_mainfile);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_link_append);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_recover_last_session);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_recover_auto_save);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_save_as_mainfile);
	WmOperatorsUtil.WM_operatortype_append(WM_OT_save_mainfile);
