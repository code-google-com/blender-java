...
public class bRotLimitConstraint implements DNA, Cloneable { // #299
  public bRotLimitConstraint[] myarray;
  public float xmin; // 4
  public float xmax; // 4
  public float ymin; // 4
  public float ymax; // 4
  ...
  public Object setmyarray(Object array) {
    myarray = (bRotLimitConstraint[])array;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("bRotLimitConstraint:\n");
  ...
  public bRotLimitConstraint copy() { try {return (bRotLimitConstraint)super.clone();} catch(CloneNotSupportedException ex) {return null;} }
}
