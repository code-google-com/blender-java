...
public class bLocLimitConstraint implements DNA, Cloneable { // #298
  public bLocLimitConstraint[] myarray;
  public float xmin; // 4
  public float xmax; // 4
  public float ymin; // 4
  public float ymax; // 4
  ...
  public Object setmyarray(Object array) {
    myarray = (bLocLimitConstraint[])array;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("bLocLimitConstraint:\n");
  ...
  public bLocLimitConstraint copy() { try {return (bLocLimitConstraint)super.clone();} catch(CloneNotSupportedException ex) {return null;} }
}
