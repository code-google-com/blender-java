...
//	};
	...
	private static PyObject make_app_info()
	{
//		extern char bprogname[]; /* argv[0] from creator.c */

		PyObject app_info;
		
		PyType info = PyType.fromClass(Object.class);
		info.__setattr__("version", Py.newString("2.56"));
		app_info = new PyObject(info);
...
//	/* end dynamic bpy.app */
	...
	public static PyObject BPY_app_struct()
	{
		PyObject ret = null;
