...
//	};
	...
	public static class props_module extends PyObject {
		public static String m_name = "bpy.props";
		public static PyObject PyModule_Create() {
			PyObject module = new PyModule(m_name);
			PyObject type = PyType.fromClass(props_module.class);
			module.__setattr__("StringProperty", type.__getattr__("BPy_StringProperty"));
			module.__setattr__("BoolProperty", type.__getattr__("BPy_BoolProperty"));
			return module;
		}
		public static String BPy_StringProperty(PyObject[] values, String[] names) {
			return "PropsModule:StringProperty";
		}
		public static boolean BPy_BoolProperty(PyObject[] values, String[] names) {
			return true;
		}
	}

	public static PyObject BPY_rna_props()
	{
		PyObject submodule;
//		PyObject *submodule_dict;
		
//		submodule= PyModule_Create(&props_module);
		submodule= props_module.PyModule_Create();
//		PyDict_SetItemString(PyImport_GetModuleDict(), props_module.m_name, submodule);
		Py.getSystemState().modules.__setitem__(props_module.m_name, submodule);
//
