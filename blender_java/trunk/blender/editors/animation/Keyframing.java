...
//	} eCommonModifyKey_Modes;
	 ...
	 */
	public static wmOperatorType.Operator modify_key_op_poll = new wmOperatorType.Operator() {
...
//		/* TODO: checks for other space types can be added here */
	...
	/* Insert Key Operator ------------------------ */
	public static wmOperatorType.Operator insert_key_exec = new wmOperatorType.Operator() {
	public int run(bContext C, wmOperator op, wmEvent event)
	{
...
//		DAG_ids_flush_update(bmain, 0);
	...
	public static OpFunc ANIM_OT_keyframe_insert = new OpFunc() {
	public void run(wmOperatorType ot)
	{
		 ...
		 */
		prop= RnaDefine.RNA_def_int(ot.srna, "type", 0, RnaDefine.INT_MIN, RnaDefine.INT_MAX, "Keying Set Number", "Index (determined internally) of the Keying Set to use", 0, 1);
		RnaDefine.RNA_def_property_flag(prop, RNATypes.PROP_HIDDEN);
		/* confirm whether a keyframe was added by showing a popup 
		 *	- by default, this is enabled, since this operator is assumed to be called independently
		 */
		prop= RnaDefine.RNA_def_boolean(ot.srna, "confirm_success", 1, "Confirm Successful Insert", "Show a popup when the keyframes get successfully added");
		RnaDefine.RNA_def_property_flag(prop, RNATypes.PROP_HIDDEN);
	}};
...
//	}
	...
	public static wmOperatorType.Operator delete_key_exec = new wmOperatorType.Operator() {
	public int run(bContext C, wmOperator op, wmEvent event)
	{
//		Main *bmain= CTX_data_main(C);
//		Scene *scene= CTX_data_scene(C);
...
//		DAG_ids_flush_update(bmain, 0);
	...
	public static OpFunc ANIM_OT_keyframe_delete = new OpFunc() {
	public void run(wmOperatorType ot)
	{
		/* identifiers */
		 ...
		 *	- here the type is int not enum, since many of the indicies here are determined dynamically
		 */
		RnaDefine.RNA_def_int(ot.srna, "type", 0, RnaDefine.INT_MIN, RnaDefine.INT_MAX, "Keying Set Number", "Index (determined internally) of the Keying Set to use", 0, 1);
		/* confirm whether a keyframe was added by showing a popup 
		 *	- by default, this is enabled, since this operator is assumed to be called independently
		 */
		RnaDefine.RNA_def_boolean(ot.srna, "confirm_success", 1, "Confirm Successful Insert", "Show a popup when the keyframes get successfully added");
	}};
