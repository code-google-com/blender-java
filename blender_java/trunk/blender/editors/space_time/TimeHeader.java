/**
 * $Id: time_header.c 21972 2009-07-28 16:33:02Z blendix $
 *
...
//
//
public static uiBlockCreateFunc time_redrawmenu = new uiBlockCreateFunc() {
...
//	short yco= 0, menuwidth=120, icon;
	...
	block= UI.uiBeginBlock(C, ar, "header time_redrawmenu", UI.UI_EMBOSSP);
...
//}
//
public static uiBlockCreateFunc time_viewmenu = new uiBlockCreateFunc() {
public uiBlock run(bContext C, ARegion ar, Object arg_unused)
...
//	short yco= 0, menuwidth=120;
	...
	block= UI.uiBeginBlock(C, ar, "time_viewmenu", UI.UI_EMBOSSP);
...
//}
//
public static uiBlockCreateFunc time_framemenu = new uiBlockCreateFunc() {
public uiBlock run(bContext C, ARegion ar, Object arg_unused)
...
//	short yco= 0, menuwidth=120;
	...
	block= UI.uiBeginBlock(C, ar, "time_framemenu", UI.UI_EMBOSSP);
...
public static void time_header_buttons(GL2 gl, bContext C, ARegion ar)
{
