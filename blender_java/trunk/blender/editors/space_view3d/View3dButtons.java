...
public class View3dButtons {

/* ******************* view3d space & buttons ************** */
public static final int B_NOP=		1;
public static final int B_REDR=		2;
public static final int B_OBJECTPANELROT= 	1007;
public static final int B_OBJECTPANELMEDIAN= 1008;
public static final int B_ARMATUREPANEL1= 	1009;
public static final int B_ARMATUREPANEL2= 	1010;
public static final int B_OBJECTPANELPARENT= 1011;
public static final int B_OBJECTPANEL=		1012;
public static final int B_ARMATUREPANEL3= 	1013;
public static final int B_OBJECTPANELSCALE= 	1014;
public static final int B_OBJECTPANELDIMS= 	1015;
public static final int B_TRANSFORMSPACEADD=	1016;
public static final int B_TRANSFORMSPACECLEAR=	1017;
public static final int B_SETPT_AUTO=	2125;
public static final int B_SETPT_VECTOR=	2126;
public static final int B_SETPT_ALIGN=	2127;
public static final int B_SETPT_FREE=	2128;
public static final int B_RECALCMBALL=	2501;

public static final int B_WEIGHT0_0=		2840;
public static final int B_WEIGHT1_4=		2841;
public static final int B_WEIGHT1_2=		2842;
public static final int B_WEIGHT3_4=		2843;
public static final int B_WEIGHT1_0=		2844;

public static final int B_OPA1_8=		2845;
public static final int B_OPA1_4=		2846;
public static final int B_OPA1_2=		2847;
public static final int B_OPA3_4=		2848;
public static final int B_OPA1_0=		2849;

public static final int B_CLR_WPAINT=	2850;

public static final int B_RV3D_LOCKED=	2900;
public static final int B_RV3D_BOXVIEW=	2901;
public static final int B_RV3D_BOXCLIP=	2902;

public static final int B_IDNAME=		3000;

/* temporary struct for storing transform properties */
static class TransformProperties {
	public float[] ob_eul = new float[4];	// used for quat too....
	public float[] ob_scale = new float[3]; // need temp space due to linked values
	public float[] ob_dims = new float[3];
	public short link_scale;
	public float[] ve_median = new float[5];
	public int curdef;
//	public float *defweightp;
};
...
//}
//
public static PanelType.Draw view3d_panel_object = new PanelType.Draw() {
...
//        System.out.println("view3d_panel_object");
	...
	//uiBut *bt;
	final bObject ob= Blender.OBACT(scene);
	final TransformProperties tfp;
	float lim;
//	static char hexcol[128];
	...
	if(v3d.properties_storage==null)
		v3d.properties_storage= new TransformProperties();
	tfp= (TransformProperties)v3d.properties_storage;

	block= UILayout.uiLayoutAbsoluteBlock((uiLayout)pa.layout);
...
//	}
	...
	lim= 10000.0f*UtilDefines.MAX2(1.0f, v3d.grid);
...
//	}
		...
		UI.uiDefBut(block, UI.LABEL, 0, "Location:", 10, 170, 100, 20, null, 0, 0, 0, 0, "");
		UI.uiBlockBeginAlign(block);
                Pointer<Short> ob_protectflag = new Pointer<Short>() {
                    public Short get() { return ob.protectflag; }
                    public void set(Short obj) { ob.protectflag = obj; }
                };
                Pointer<Float> ob_loc0 = new Pointer<Float>() {
                    public Float get() { return ob.loc[0]; }
                    public void set(Float obj) { ob.loc[0] = obj; }
                };
                Pointer<Float> ob_loc1 = new Pointer<Float>() {
                    public Float get() { return ob.loc[1]; }
                    public void set(Float obj) { ob.loc[1] = obj; }
                };
                Pointer<Float> ob_loc2 = new Pointer<Float>() {
                    public Float get() { return ob.loc[2]; }
                    public void set(Float obj) { ob.loc[2] = obj; }
                };
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_LOCX, B_REDR, BIFIconID.ICON_UNLOCKED,	10,150,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANEL, "X:",		30, 150, 120, 19, ob_loc0, -lim, lim, 100, 3, "");
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_LOCY, B_REDR, BIFIconID.ICON_UNLOCKED,	10,130,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANEL, "Y:",		30, 130, 120, 19, ob_loc1, -lim, lim, 100, 3, "");
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_LOCZ, B_REDR, BIFIconID.ICON_UNLOCKED,	10,110,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANEL, "Z:",		30, 110, 120, 19, ob_loc2, -lim, lim, 100, 3, "");

		tfp.ob_eul[0]= 180.0f*ob.rot[0]/Arithb.M_PI;
		tfp.ob_eul[1]= 180.0f*ob.rot[1]/Arithb.M_PI;
		tfp.ob_eul[2]= 180.0f*ob.rot[2]/Arithb.M_PI;

		UI.uiBlockBeginAlign(block);
                Pointer<Float> tfp_ob_eul0 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_eul[0]; }
                    public void set(Float obj) { tfp.ob_eul[0] = obj; }
                };
                Pointer<Float> tfp_ob_eul1 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_eul[1]; }
                    public void set(Float obj) { tfp.ob_eul[1] = obj; }
                };
                Pointer<Float> tfp_ob_eul2 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_eul[2]; }
                    public void set(Float obj) { tfp.ob_eul[2] = obj; }
                };
		if ((ob.parent!=null) && (ob.partype == ObjectTypes.PARBONE)) {
...
//			uiDefButF(block, NUM, B_OBJECTPANELROT, "Z:",	180, 90, 120, 19, &(tfp.ob_eul[2]), -lim, lim, 1000, 3, "");
			...
			UI.uiDefBut(block, UI.LABEL, 0, "Rotation:",					160, 170, 100, 20, null, 0, 0, 0, 0, "");
			UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_ROTX, B_REDR, BIFIconID.ICON_UNLOCKED,	160,150,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
			UI.uiDefButF(block, UI.NUM, B_OBJECTPANELROT, "X:",	180, 150, 120, 19, tfp_ob_eul0, -lim, lim, 1000, 3, "");
			UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_ROTY, B_REDR, BIFIconID.ICON_UNLOCKED,	160,130,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
			UI.uiDefButF(block, UI.NUM, B_OBJECTPANELROT, "Y:",	180, 130, 120, 19, tfp_ob_eul1, -lim, lim, 1000, 3, "");
			UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_ROTZ, B_REDR, BIFIconID.ICON_UNLOCKED,	160,110,20,19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
			UI.uiDefButF(block, UI.NUM, B_OBJECTPANELROT, "Z:",	180, 110, 120, 19, tfp_ob_eul2, -lim, lim, 1000, 3, "");
		}
		...
		UI.uiDefBut(block, UI.LABEL, 0, "Scale:",					10, 90, 100, 20, null, 0, 0, 0, 0, "");
		UI.uiBlockBeginAlign(block);
                Pointer<Float> tfp_ob_scale0 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_scale[0]; }
                    public void set(Float obj) { tfp.ob_scale[0] = obj; }
                };
                Pointer<Float> tfp_ob_scale1 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_scale[1]; }
                    public void set(Float obj) { tfp.ob_scale[1] = obj; }
                };
                Pointer<Float> tfp_ob_scale2 = new Pointer<Float>() {
                    public Float get() { return tfp.ob_scale[2]; }
                    public void set(Float obj) { tfp.ob_scale[2] = obj; }
                };
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_SCALEX, B_REDR, BIFIconID.ICON_UNLOCKED,	10, 70, 20, 19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANELSCALE, "X:",							30, 70, 120, 19, tfp_ob_scale0, -lim, lim, 10, 3, "");
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_SCALEY, B_REDR, BIFIconID.ICON_UNLOCKED,	10, 50, 20, 19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANELSCALE, "Y:",							30, 50, 120, 19, tfp_ob_scale1, -lim, lim, 10, 3, "");
		UI.uiDefIconButBitS(block, UI.ICONTOG, ObjectTypes.OB_LOCK_SCALEZ, B_REDR, BIFIconID.ICON_UNLOCKED,	10, 30, 20, 19, ob_protectflag, 0, 0, 0, 0, "Protects this value from being Transformed");
		UI.uiDefButF(block, UI.NUM, B_OBJECTPANELSCALE, "Z:",							30, 30, 120, 19, tfp_ob_scale2, -lim, lim, 10, 3, "");
		UI.uiBlockEndAlign(block);

                Pointer<Short> tfp_link_scale = new Pointer<Short>() {
                    public Short get() { return tfp.link_scale; }
                    public void set(Short obj) { tfp.link_scale = obj; }
                };
		UI.uiDefButS(block, UI.TOG, B_REDR, "Link Scale",		10, 0, 140, 19, tfp_link_scale, 0, 1, 0, 0, "Scale values vary proportionally in all directions");

		bb= ObjectUtil.object_get_boundbox(ob);
		if (bb!=null) {
			float[] scale = new float[3];

			Arithb.Mat4ToSize(ob.obmat, scale);

			tfp.ob_dims[0] = StrictMath.abs(scale[0]) * (bb.vec[4][0] - bb.vec[0][0]);
			tfp.ob_dims[1] = StrictMath.abs(scale[1]) * (bb.vec[2][1] - bb.vec[0][1]);
			tfp.ob_dims[2] = StrictMath.abs(scale[2]) * (bb.vec[1][2] - bb.vec[0][2]);

                        Pointer<Float> tfp_ob_dims0 = new Pointer<Float>() {
                            public Float get() { return tfp.ob_dims[0]; }
                            public void set(Float obj) { tfp.ob_dims[0] = obj; }
                        };
                        Pointer<Float> tfp_ob_dims1 = new Pointer<Float>() {
                            public Float get() { return tfp.ob_dims[1]; }
                            public void set(Float obj) { tfp.ob_dims[1] = obj; }
                        };
                        Pointer<Float> tfp_ob_dims2 = new Pointer<Float>() {
                            public Float get() { return tfp.ob_dims[2]; }
                            public void set(Float obj) { tfp.ob_dims[2] = obj; }
                        };
			if ((ob.parent!=null) && (ob.partype == ObjectTypes.PARBONE)) {
...
//
				...
				UI.uiDefBut(block, UI.LABEL, 0, "Dimensions:",			160, 90, 100, 20, null, 0, 0, 0, 0, "");
				UI.uiBlockBeginAlign(block);
				UI.uiDefButF(block, UI.NUM, B_OBJECTPANELDIMS, "X:",		160, 70, 140, 19, tfp_ob_dims0, 0.0f, lim, 10, 3, "Manipulate bounding box size");
				UI.uiDefButF(block, UI.NUM, B_OBJECTPANELDIMS, "Y:",		160, 50, 140, 19, tfp_ob_dims1, 0.0f, lim, 10, 3, "Manipulate bounding box size");
				UI.uiDefButF(block, UI.NUM, B_OBJECTPANELDIMS, "Z:",		160, 30, 140, 19, tfp_ob_dims2, 0.0f, lim, 10, 3, "Manipulate bounding box size");
			}
...
public static void view3d_buttons_register(ARegionType art)
{
	PanelType pt;

	pt= new PanelType();
	StringUtil.strcpy(pt.idname,0, StringUtil.toCString("VIEW3D_PT_object"),0);
	StringUtil.strcpy(pt.label,0, StringUtil.toCString("Transform"),0);
...
//	pt= new PanelType();
//	StringUtil.strcpy(pt.idname,0, StringUtil.toCString("VIEW3D_PT_bonesketch_spaces"),0);
//	StringUtil.strcpy(pt.label,0, StringUtil.toCString("Bone Sketching"),0);
...
public static wmOperatorType.Operator view3d_properties = new wmOperatorType.Operator() {
...
//static int view3d_properties(bContext *C, wmOperator *op)
{
	...
	ARegion ar= SpaceView3dUtil.view3d_has_buttons_region(sa);
...
public static OpFunc VIEW3D_OT_properties = new OpFunc() {
