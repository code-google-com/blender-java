...
import static blender.blenkernel.image.*;

import blender.makesrna.RNATypes.EnumPropertyItem;

public class RnaImageUtil {
//	/**
...
//	#include "WM_types.h"
	...
	static EnumPropertyItem image_source_items[]= {
		new EnumPropertyItem(IMA_SRC_FILE, "FILE", 0, "File", "Single image file"),
		new EnumPropertyItem(IMA_SRC_SEQUENCE, "SEQUENCE", 0, "Sequence", "Multiple image files, as a sequence"),
		new EnumPropertyItem(IMA_SRC_MOVIE, "MOVIE", 0, "Movie", "Movie file"),
		new EnumPropertyItem(IMA_SRC_GENERATED, "GENERATED", 0, "Generated", "Generated image"),
		new EnumPropertyItem(IMA_SRC_VIEWER, "VIEWER", 0, "Viewer", "Compositing node viewer"),
