...
class ANIM_OT_keying_set_export(bpy.types.Operator):
    ...
    filter_folder = bpy.props.BoolProperty(name="Filter folders", description="", default=True, options=set(['HIDDEN']))
    filter_text = bpy.props.BoolProperty(name="Filter text", description="", default=True, options=set(['HIDDEN']))
    filter_python = bpy.props.BoolProperty(name="Filter python", description="", default=True, options=set(['HIDDEN']))
