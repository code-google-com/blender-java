...
class VIEW3D_MT_edit_text_chars(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("font.text_insert", text="Copyright|Alt C").text = '\xC2\xA9'.decode()
        layout.operator("font.text_insert", text="Registered Trademark|Alt R").text = '\xC2\xAE'.decode()

        layout.separator()

        layout.operator("font.text_insert", text="Degree Sign|Alt G").text = '\xC2\xB0'.decode()
        layout.operator("font.text_insert", text="Multiplication Sign|Alt x").text = '\xC3\x97'.decode()
        layout.operator("font.text_insert", text="Circle|Alt .").text = '\xC2\x8A'.decode()
        layout.operator("font.text_insert", text="Superscript 1|Alt 1").text = '\xC2\xB9'.decode()
        layout.operator("font.text_insert", text="Superscript 2|Alt 2").text = '\xC2\xB2'.decode()
        layout.operator("font.text_insert", text="Superscript 3|Alt 3").text = '\xC2\xB3'.decode()
        layout.operator("font.text_insert", text="Double >>|Alt >").text = '\xC2\xBB'.decode()
        layout.operator("font.text_insert", text="Double <<|Alt <").text = '\xC2\xAB'.decode()
        layout.operator("font.text_insert", text="Promillage|Alt %").text = '\xE2\x80\xB0'.decode()

        layout.separator()

        layout.operator("font.text_insert", text="Dutch Florin|Alt F").text = '\xC2\xA4'.decode()
        layout.operator("font.text_insert", text="British Pound|Alt L").text = '\xC2\xA3'.decode()
        layout.operator("font.text_insert", text="Japanese Yen|Alt Y").text = '\xC2\xA5'.decode()

        layout.separator()

        layout.operator("font.text_insert", text="German S|Alt S").text = '\xC3\x9F'.decode()
        layout.operator("font.text_insert", text="Spanish Question Mark|Alt ?").text = '\xC2\xBF'.decode()
        layout.operator("font.text_insert", text="Spanish Exclamation Mark|Alt !").text = '\xC2\xA1'.decode()
